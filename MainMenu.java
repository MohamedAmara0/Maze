...
public class MainMenu {
	...
	public MainMenu() {
		...
		//tune the frame to an appropriate setting
		...
		//if play is clicked, dispose of the current frame and call Difficulty -- Raed
		...
		//if instruction is clicked, make a new frame with all the instructions written in them. -- Raed, Mohamed
